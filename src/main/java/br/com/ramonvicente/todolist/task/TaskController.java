package br.com.ramonvicente.todolist.task;
...
import br.com.ramonvicente.todolist.utils.Utils;
...
public class TaskController{
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if(currentDate.isAfter(taskModel.getStartAt()) || currentDate.isAfter(taskModel.getEndAt())) {
            ...
            .body("A Data de inicio ou a data final não podem ser menores que a adata atual.");
        }

        if(taskModel.getStartAt().isAfter(taskModel.getEndAt()) || currentDate.isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
            .body("A Data de inicio não pode ser depois da  data final.");
        }
